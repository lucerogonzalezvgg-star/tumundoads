...
const PLANES = {
  ...
  googleads_curso: {
    nombre: "Curso de Google Ads Básico",
    hotmart: "https://pay.hotmart.com/P106461586S",
    mercadopago: "https://mpago.la/1HjQ6Ud",
    binance: true,
    pagomovil: true,
    descarga: true
  }
...
function mostrarOpciones(plan) {
  ...
  // Si el plan incluye descarga, mostrar nota informativa arriba
  if (plan.descarga) {
    const nota = document.createElement("div");
    nota.style.cssText = "background:#F0FDF4;border:1px solid #86EFAC;border-radius:8px;padding:0.75rem 1rem;margin-bottom:1rem;font-size:0.85rem;color:#166534;display:flex;align-items:center;gap:0.5rem;";
    nota.innerHTML = "📦 <strong>Incluye descarga ZIP</strong> — Recibirás el curso completo con acceso al HTML interactivo y certificado.";
